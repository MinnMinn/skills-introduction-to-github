...
Equivalent of internal/domain/user.go DTO section in the standard Go layout.

These types live in the domain package because they express the shape of
data entering and leaving the system — they are part of the public contract,
not an implementation detail of the HTTP layer.
"""
